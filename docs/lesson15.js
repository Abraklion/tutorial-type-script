...
//     value: 'password'
// });
// Пример 2 (Декоратор замараживает конструктор и прототип)
function addConsole(constructor, context) {
    var newConstruct = function (name) {
...
var User = function () {
    var _classDecorators = [addConsole];
    ...
    var User = _classThis = /** @class */ (function () {
        ...
        User_1.prototype.printName = function () {
            console.log(this.name);
        };
        return User_1;
    }());
